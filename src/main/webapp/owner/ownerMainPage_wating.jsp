...
<body>
	<h1>ownerMainPage_wating.jsp</h1>
	...
	<div style="text-align: center;">
		<input type="text" style="border-radius: 50%; height: 150px; text-align: center;" value="여기 el표현식으로 출력">
	</div>
	
	<div style="text-align: right;" >
		<input type="button" value="on/off" onclick="">
	</div>
	...
	<table>
		<tr>
			<th style="padding-right : 5em; padding-left: 6em; ">대기 번호</th>
			<th style="padding-right : 5em; ">회원 이름</th>
			<th style="padding-right : 5em; ">회원 전화번호</th>
			<th>인원수</th>
		</tr> 
	</table>
	</div>
